---
title: "boot9strap 설치 (MSET9 Play 스토어)"
---
...
1. [MSET9 Installer 앱](/images/screenshots/mset9/mset9-setup-android.png) 을 실행해 주세요
1. `Select "Nintendo 3DS" Folder`(Nintendo 3DS 폴더 선택)을 터치한 다음, SD 카드 내의 `Nintendo 3DS` 폴더로 들어가 주세요 ([예시](/images/screenshots/mset9/select-mset9-folder-1.png))
1. `Nintendo 3DS` 폴더에 들어간 후, "Use this folder" (이 폴더 사용)을 터치한 다음, "Allow" 를 눌러 접근을 허용해줍니다 ([예시](/images/screenshots/mset9/select-mset9-folder-2.png))
...
1. SD 카드를 휴대폰/태블릿/컴퓨터에 삽입해 주세요
1. MSET9 Installer를 실행해 주세요
1. "Setup MSET9" (MSET9 설치)를 터치해 주세요
...
1. SD 카드를 휴대폰/태블릿/컴퓨터에 삽입해 주세요
1. MSET9 Installer를 실행해 주세요
1. "Remove MSET9" (MSET9 제거) 를 터치해 주세요
1. MSET9 Installer를 종료해 주세요
