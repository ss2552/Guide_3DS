...
We're glad to hear that you'd like to contribute to 3ds.hacks.guide! Hier sind ein paar Möglichkeiten, wie du das tun kannst:
...
Ein Teil der Dateien in dieser Anleitung sind nur als Torrents verfügbar. If you'd like to help seed these torrents to ensure their availability in the future, you can download the `.zip` file containing all our `.torrent` files: [torrents.zip](/assets/torrents.zip) (last updated 2023-03-16)

Es gibt auch einen [RSS feed]({{ "rss.xml" | absolute_url }}) den du abonnieren kannst, der für zukünftige Torrents aktualisiert werden kann.
