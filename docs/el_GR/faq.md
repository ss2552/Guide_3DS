...
Ανατρέξτε στον [οδηγό επίλυσης προβλημάτων](/el_GR/troubleshooting#ζητηματα-εκκινησης-σε-κονσολες-με-custom-firmware). **Δεν προτείνεται η αφαίρεση του CFW όταν η κονσόλα σας βρίσκεται σε κατάσταση αδυναμίας εκκίνησης, καθώς είναι πολύ πιθανό να καταστεί μη λειτουργική**.
