...
2. Attendi il termine di tutti i controlli di sicurezza
    - Se ottieni un errore "OTP Crypto Fail", scarica <font-awesome-icon icon="fa-solid fa-magnet"/> - aeskeydb.bin, quindi spostalo nella cartella `/boot9strap/` della tua scheda SD e riprova
